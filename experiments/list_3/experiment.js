...
const irb = {
    ...
    stimulus: `
        <div style="font-size: 16px; text-align: center; margin-top: 25px; margin-right: 100px; margin-left: 100px; margin-bottom: 25px;">
            <img src="./image/SUSig_2color_Stree_Left.png" alt="Stanford Logo" style="max-width: 200px; margin-bottom: 20px;">
            <h3>DESCRIPTION</h3>
            <p>You are invited to participate in a research study. Its general purpose is to understand how people perceive speech...</p>
            <h3>TIME INVOLVEMENT</h3> 
            <p>Your participation will take approximately 10 minutes.</p>
            <h3>RISKS AND BENEFITS</h3>
            <p>The foreseeable risks associated with this study are minimal...</p>
            <h3>PAYMENT</h3> 
            <p>You will be paid at the posted rate.</p>
            <h3>PARTICIPANT RIGHTS</h3> 
            <p>If you have read this form and have decided to participate in this project, please understand your participation is voluntary...</p>
            <h3>CONTACT INFORMATION</h3>
            <p>If you have any questions, concerns or complaints about this research study...</p> 
...
//PRELOAD AUDIO//
const preload_array = [
    "audio/246_SN1_mid.wav", "audio/723_SN1_mid.wav",
    "audio/246_CN1.wav", "audio/723_CN1.wav",
    "audio/246_SN2_high.wav", "audio/723_SN2_high.wav",
    "audio/246_CN2.wav", "audio/723_CN2.wav",
    "audio/246_SN3_mid.wav", "audio/723_SN3_mid.wav",
    "audio/246_CN3.wav", "audio/723_CN3.wav",
    "audio/246_SN4_high.wav", "audio/723_SN4_high.wav",
    "audio/246_CN4.wav", "audio/723_CN4.wav",
    "audio/246_SN5_low.wav", "audio/723_SN5_low.wav",
    "audio/246_CN5.wav", "audio/723_CN5.wav",
    "audio/246_SN7_mid.wav", "audio/723_SN7_mid.wav",
    "audio/246_CN7.wav", "audio/723_CN7.wav",
    "audio/246_SN8_mid.wav", "audio/723_SN8_mid.wav",
    "audio/246_CN8.wav", "audio/723_CN8.wav",
    "audio/246_SN9_low.wav", "audio/723_SN9_low.wav",
    "audio/246_CN9.wav", "audio/723_CN9.wav",
    "audio/246_SN10_high.wav", "audio/723_SN10_high.wav",
    "audio/246_CN10.wav", "audio/723_CN10.wav",
    "audio/246_SN13_mid.wav", "audio/723_SN13_mid.wav",
    "audio/246_CN13.wav", "audio/723_CN13.wav",
    "audio/246_SN14_mid.wav", "audio/723_SN14_mid.wav",
    "audio/246_CN14.wav", "audio/723_CN14.wav",
    "audio/246_SN15_low.wav", "audio/723_SN15_low.wav",
    "audio/246_CN15.wav", "audio/723_CN15.wav",
    "audio/246_SN16_high.wav", "audio/723_SN16_high.wav",
    "audio/246_CN16.wav", "audio/723_CN16.wav",
    "audio/246_SN17_high.wav", "audio/723_SN17_high.wav",
    "audio/246_CN17.wav", "audio/723_CN17.wav",
    "audio/246_SN18_low.wav", "audio/723_SN18_low.wav",
    "audio/246_CN18.wav", "audio/723_CN18.wav",
    "audio/246_SN19_low.wav", "audio/723_SN19_low.wav",
    "audio/246_CN19.wav", "audio/723_CN19.wav",
    "audio/246_SN20_low.wav", "audio/723_SN20_low.wav",
    "audio/246_CN20.wav", "audio/723_CN20.wav",
    "audio/246_SN21_high.wav", "audio/723_SN21_high.wav",
    "audio/246_CN21.wav", "audio/723_CN21.wav",
    "audio/gift.wav"
  ];  
const preload_trial = {
    type: jsPsychPreload,
